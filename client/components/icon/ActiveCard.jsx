    ...
    return (
        ...
        <div style={activeSkill.name === "Redux" ? {marginTop: '2.75%'}: null}>
            <div className="header">
                ...
                activeSkill.icon === "DiGithubBadge" ? <DiGithubBadge style={{ fontSize: '6rem', color: '#181616'}} /> :
                ...
                activeSkill.icon === "img src='../static/redux.png' alt='Redux Icon'" ? <img src='../static/redux.png' alt='Redux Icon' style={{ width: '75px', maxHeight: '70px', marginRight: '2%' }} /> :
